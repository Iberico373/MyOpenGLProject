...
#include <GLAD/gl.h>
#include "Vertex.h"
#include "../Application/Source/ShaderManager.h"

#include <iostream>
#include <vector>
#include <chrono>

#include "../Application/Source/AppOptions.h"
...
public:
	...
	void Render(Camera* cam, float dt)
	{
		...
		mvp = glm::mat4(1.0f); 
		mvp = glm::translate(mvp, glm::vec3(0.f, 0.f, 0.0f));
		angle += dt * 10;
		mvp = glm::rotate(mvp, float(glm::radians(angle)), glm::vec3(1, 1, 1));
		mvp = cam->GetProjection() * cam->GetView() * mvp;	
